...
final class RightPanel extends JPanel
{
   ...
   private static final int FONT_LIN = 9;
   private final int buttonFontSize;

   public static final String LOGOPATH = "net/schwagereit/t1j/images/t1j.png";
   ...
   public static final String ICONPATH = "net/schwagereit/t1j/images/t1jIcon.gif";
